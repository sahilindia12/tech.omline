          ...
          <div class="row">
            ...
            <div class="col-6 col-lg-2 mb-3">
              ...
              <ul class="list-unstyled">
                ...
                <li class="mb-2"><a href="https://github.com/twbs/bootstrap/discussions" target="_blank" rel="noopener">Discussions</a></li>  <li class="mb-2"><a href="https://stackoverflow.com/questions/tagged/bootstrap-5" target="_blank" rel="noopener">Stack Overflow</a></li>
              </ul>
            </div>
          </div>
        </div>
        <div className=' flex justify-center'><p>this is footer by sahil inida copy2024 pwered by sahilindia</p></div>
